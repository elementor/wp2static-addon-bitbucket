...
class Wp2static_Addon_Bitbucket {
	...
	public function __construct() {
		...
		$this->plugin_name = 'wp2static-addon-bitbucket';
	...
	private function load_dependencies() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp2static-addon-bitbucket-loader.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp2static-addon-bitbucket-admin.php';

		$this->loader = new Wp2static_Addon_Bitbucket_Loader();
	}

	private function define_admin_hooks() {
		$plugin_admin = new Wp2static_Addon_Bitbucket_Admin( $this->get_plugin_name(), $this->get_version() );
    ...
    public function add_deployment_option_to_ui( $deploy_options ) {
        $deploy_options['bitbucket'] = array('Bitbucket');

        return $deploy_options;
    }

    public function load_deployment_option_template( $templates ) {
        $templates[] =  __DIR__ . '/../views/bitbucket_settings_block.phtml';
